class ServertTest1
{
	...
	public static void Main()
	{
		...
		master.SingleItems.Add("Speed", 3.6); //seems to be in m/s, transform to km/h
		...
		master.SingleTransformation.Add("SpeedLimit", 3.6); //seems to be in m/s, transform to km/h
		...
		master.SingleTransformation.Add("NextSpeedLimit", 3.6); //seems to be in m/s, transform to km/h
