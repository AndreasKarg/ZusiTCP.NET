class ServertTest1
{
	...
	public static void Main()
	{
		...
		var client = new Zusi_Datenausgabe.ZusiTcp3TypeClient("Beispielclient", "1.0.0.0", 
										(System.Threading.SynchronizationContext) null);
		System.Console.WriteLine("Set up Client successfull");
		client.RequestData(0x1);
	...
	{
		System.Console.WriteLine(string.Format("v = {0} km/h", data.Value * 3.6));
	}
}
